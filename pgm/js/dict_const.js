...
var DictConst = {
  ...
  C_TOP_PUBLISHING_XML_PATH                 : '../{manual_path}/pub_sys/publishing.xml',
  C_TOP_YOKOGUSHI_HELP                      : '../system/guide/html/yokogushihelp.html',
  ...
  C_SERVICE_OPEN_YOKOGUSHI_HELP             : '../system/guide/html/yokogushihelp.html',
  ...
  C_SERVICE_REPAIR_DIAGFLW_PATH             : '../{manual_path}/repair/contents/flow/{0}_flow.html',
  //閲覧画面 (新型車解説書)
  ...
  //横串検索
  C_SERVICE_YOKOGUSHI_INDEX_XML_PATH        : '../{manual_path}/pub_sys/yokogushi/yokogushi-index-{1}.xml',
  //コンテンツ
  C_CONTENTS_FLOW_CONTENT_PATH              : '../{0}.html',
...
DictConst.Keys = [
  ...
  'C_TOP_PUBLISHING_XML_PATH',
  'C_TOP_YOKOGUSHI_HELP',
  'C_TOP_RM_XML_PATH',
  ...
  //横串検索
  'C_SERVICE_YOKOGUSHI_INDEX_XML_PATH',
  //コンテンツ
  'C_CONTENTS_FLOW_CONTENT_PATH',
